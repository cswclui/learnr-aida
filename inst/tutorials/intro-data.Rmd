...
In this lab we explore a random
sample of domestic flights departing from the three major 
...
*variable*. R calls this data format a **data frame**. For this data set, each *observation* is a single flight.
